...
class UserServiceTest {
    ...
    List<GranadaUser> hogwartsUsers;
    ...
    void testFindAllSuccess() {
        ...
        List<GranadaUser> actualUsers = this.userService.findAll();
    ...
    void testFindByIdSuccess() {
        ...
        // When. Act on the target behavior. Act steps should cover the method to be tested.
        GranadaUser returnedUser = this.userService.findById(1);
    ...
    void testSaveSuccess() {
        // Given
        GranadaUser newUser = new GranadaUser();
        ...
        // When
        GranadaUser returnedUser = this.userService.save(newUser);
    ...
    void testUpdateSuccess() {
        // Given
        GranadaUser oldUser = new GranadaUser();
        oldUser.setId(1);
        ...
        GranadaUser update = new GranadaUser();
        ...
        // When
        GranadaUser updatedUser = this.userService.update(1, update);
