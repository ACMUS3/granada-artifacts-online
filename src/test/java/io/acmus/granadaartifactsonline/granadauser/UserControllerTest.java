...
class UserControllerTest {
    ...
    void testAddUserSuccess() throws Exception {
        ...
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        given(this.userService.save(Mockito.any(GranadaUser.class))).willReturn(user);
    ...
    void testUpdateUserSuccess() throws Exception {
        ...
        GranadaUser updatedUser = new GranadaUser();
        updatedUser.setId(3);
        ...
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        given(this.userService.update(eq(3), Mockito.any(GranadaUser.class))).willReturn(updatedUser);
    ...
    void testUpdateUserErrorWithNonExistentId() throws Exception {
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        given(this.userService.update(eq(5), Mockito.any(GranadaUser.class))).willThrow(new ObjectNotFoundException("user", 5));
